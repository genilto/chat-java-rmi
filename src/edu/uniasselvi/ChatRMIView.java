...
public class ChatRMIView extends FrameView {
    ...
    public void connectServer() {
        try {
            ...
            this.porta = Solicita.getInteger("Informe a Porta", true, this.porta);
    ...
    public void startServer() {
        ...
        try {
            ...
            this.porta = Solicita.getInteger("Informe a porta desejada", true, this.porta);
            ...
            //Liga o stub do objeto remoto no registro, e inicia o RMIRegistry na porta escolhida
            if (registryServer == null) {
                registryServer = LocateRegistry.createRegistry(this.porta);
            }
            registryServer.bind("ServidorRMI", chatServer);

            // Adiciona um texto no Log
            serverLog.appendLog("Servidor está no ar... Seu IP é: " + this.hostaddress + ":" + this.porta);
